  ...
  return (
    <ScreenContainer className="flex-1" containerClassName="bg-background">
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.records}><LinkedRecord icon="precision-manufacturing" title="Machine 14 requires inspection" detail="North Plant · Cooling return is outside normal band" severity="high" onPress={() => router.push({ pathname: "/asset/[id]", params: { id: "MX-14" } })} /><LinkedRecord icon="account-tree" title="LifeHouse Site West" detail="68% complete · Delivery release needs protection" severity="attention" onPress={() => router.push({ pathname: "/project/[id]", params: { id: "LH-01" } })} /><LinkedRecord icon="engineering" title="Operational fabric" detail="Production, inventory, quality, safety, and traceable evidence" onPress={() => router.push("/operations")} /><LinkedRecord icon="local-shipping" title="Commerce & dispatch" detail="Order SO-812, inbound batch and delivery readiness" onPress={() => router.push("/commerce")} /></View>
